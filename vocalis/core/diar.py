"""Speaker Diarization Module for Vocalis
...
from vocalis.core.model import get_speaker_diarization, read_wave
    ...
    def create_transcript_with_speakers(self, 
        ...
        for seg in transcript_segments:
            ...
            for diar_seg in diarization_segments:
                # Get start and end times from the segment
                diar_start = diar_seg["start"] if isinstance(diar_seg, dict) else diar_seg.start_time
                diar_end = diar_seg["end"] if isinstance(diar_seg, dict) else diar_seg.end_time
                diar_speaker = diar_seg["speaker"] if isinstance(diar_seg, dict) else f"Speaker {diar_seg.speaker_id}"
